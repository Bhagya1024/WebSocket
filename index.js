...
wsServer.on("request", request => {
    ...
    connection.on("message", message => {
        ...
        if (result.method === "play") {
            ...
            const clientX = result.clientX;
            const clientY = result.clientY;
            const mstate=result.mstate;
            ...
            games[gameId].stateX=clientX;
            games[gameId].stateY=clientY;
            games[gameId].mState=mstate;
            updateGameState();
        }

        if(result.method === "drawing") {
            const gameId = result.gameId;
            const ballId = result.ballId;
            const color = result.color;
            let state = games[gameId].state;
